                ...
                {data?.length === 0 ? (
                  ...
                  <div className="h-[500px] overflow-auto border p-4 rounded-md flex flex-col gap-4 w-full">
                    {data.map((item) => (
                      ...
                      >
                        <img
                          src="https://freelanced-res.cloudinary.com/image/upload/f_auto,q_auto/v1/attachments/generic_asset/asset/c51dbf5c160dac9bd067442911e65d16-1626181910196/Miscellaneous_2x.png"
                          alt="sender_img"
